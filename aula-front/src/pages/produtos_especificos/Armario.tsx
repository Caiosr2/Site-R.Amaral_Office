...
const Armario = () => {
  return (
    <PageWrapper>
      <Container>
        <RightColumn>
          <ProductImage src={armario} alt="Armário de Escritório Yaris com Nichos" />
        </RightColumn>

        <LeftColumn>
          <Breadcrumb>
            <StyledLink to="/produtos?categoria=Móveis">Móveis</StyledLink> &gt;{" "}
            <StyledLink to="/produtos?categoria=Móveis,Armários">Armário</StyledLink> &gt;{" "}
            <span>Armário Yaris com Nichos</span>
          </Breadcrumb>

          <Title>Armário de Escritório Yaris com Nichos</Title>
          <Price>R$ 779,99</Price>

          <Description>
            O Armário Yaris oferece praticidade com um visual moderno, ideal para escritórios, home offices ou ambientes corporativos. Possui 2 portas e nichos abertos, permite armazenar documentos, livros, materiais e objetos decorativos com fácil acesso e discrição.
          </Description>

          <FeatureList>
            <li>Nichos abertos funcionais para itens de uso frequente ou decoração</li>
