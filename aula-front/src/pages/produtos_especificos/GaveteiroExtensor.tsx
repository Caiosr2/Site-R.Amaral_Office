...
import extensor from "../../assets/gaveteiroextensor.png";

const GaveteiroExtensor = () => {
  return (
    <PageWrapper>
      <Container>
        <RightColumn>
          <ProductImage src={extensor} alt="Gaveteiro com Extensor Yaris 4 GV" />
        </RightColumn>
        ...
        <LeftColumn>
          <Breadcrumb>
            ...
            <span>Gaveteiro com Extensor Yaris 4 GV</span>
          </Breadcrumb>

          <Title>Gaveteiro com Extensor Yaris 4 GV</Title>
          <Price>R$ 619,99</Price>

          <Description>
            O Gaveteiro Yaris com extensor é ideal para quem precisa de espaço extra para organização sem abrir mão da elegância. 
          ...
          <FeatureList>
            <li>4 gavetas com corrediças metálicas e puxadores discretos</li>
...
export default GaveteiroExtensor;